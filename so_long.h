...
/*   Updated: 2022/06/27 22:17:26 by fchanane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_moves(int counter);
...
void	move_right(char **the_maze, int *counter, int *rm_clc);
void	move_left(char **the_maze, int *counter, int *rm_clc);
void	move_up(char **the_maze, int *counter, int *rm_clc, int lines);
void	move_down(char **the_maze, int *counter, int *rm_clc);
